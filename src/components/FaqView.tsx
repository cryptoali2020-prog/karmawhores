    ...
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-10">
        ...
        <div className="relative max-w-md mx-auto">
          <input
            ...
            className="w-full px-4 py-2.5 bg-[#111726] border border-[#1e293b] rounded-xl text-white text-sm focus:outline-none focus:border-[#FF4500] pl-10"
          />
      ...
      <div className="space-y-4">
        {filteredFaqs.length === 0 ? (
          <div className="text-center py-10 bg-[#111625] rounded-2xl border border-dashed border-slate-700">
            ...
            <button 
              ...
              className="mt-3 text-xs text-[#FF4500] underline uppercase tracking-wider font-mono font-bold"
            >
              Clear filters
            </button>
          </div>
          ...
          filteredFaqs.map((faq) => {
            ...
            return (
              <div
                key={faq.id}
                className={`bg-[#111625] rounded-2xl border ${isExpanded ? 'border-[#FF4500]/40 shadow-md shadow-[#FF4500]/5' : 'border-[#1e293b]'} transition-all`}
              >
                <button
                ...
                >
                  <div className="flex items-center gap-3.5 pr-4">
                    <div className={`p-2 rounded-lg ${isExpanded ? 'bg-[#FF4500]/10 text-[#FF4500]' : 'bg-[#162035] text-[#FFB000]'} shrink-0 transition-colors`}>
                      <HelpCircle size={16} />
                    </div>
      ...
      <div className="bg-gradient-to-r from-[#111625] to-[#162035] rounded-2xl border border-[#1e293b] p-6 mt-12 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-4 text-center sm:text-left flex-col sm:flex-row">
          <div className="p-3.5 rounded-2xl bg-gradient-to-br from-[#FF4500] to-[#FFB000] text-white">
        ...
        <a
          href="#contact"
          className="shrink-0 w-full sm:w-auto py-3 px-5 rounded-xl bg-slate-800 hover:bg-slate-750 text-white border border-[#27314a] text-xs font-semibold text-center transition-colors shadow-sm"
        >
          Open Support Ticket
        </a>
      </div>
